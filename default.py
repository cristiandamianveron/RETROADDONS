...
addon = xbmcaddon.Addon('plugin.video.RETROADDONS')
...
SOURCES = [{"url":"https://www.dropbox.com/s/5wowxo4phnq7z56/PRINCIPALRETROADDONS.xml.xml?dl=0", "fanart": "https://bibliotecadeinvestigaciones.files.wordpress.com/2012/01/pasado-perfecto.jpg", "genre": "Tv Live", "date": "25.11.2015", "credits": "VERON", "thumbnail": "http://orig12.deviantart.net/9da2/f/2009/010/b/c/retro_by_vinhfx.jpg"}]
...
def addon_log(string):
    if debug == 'true':
        xbmc.log("[addon.RETROADDONS-%s]: %s" %(addon_version, string))
